                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm">
                      กรุณาติดต่อ: <span className="font-medium">สำนักวิทยบริการและเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏนครศรีธรรมราช</span>
                      <br />
                      หรือสมัครเข้าใช้งานและรอการอนุมัติจากผู้ดูแล
                    </p>
                  </div>
                </div>
              </div>
