...
INSERT INTO "new_domain_requests" ("approvalCooldownAt", "contact", "contactType", "department", "domain", "durationType", "expiresAt", "id", "ipAddress", "machineAdminContact", "machineAdminContactType", "machineAdminName", "machineAdminPosition", "purpose", "requestedAt", "requesterName", "responsibleContact", "responsibleContactType", "responsibleName", "status", "userId") SELECT "approvalCooldownAt", "contact", "contactType", "department", "domain", "durationType", "expiresAt", "id", "ipAddress", "machineAdminContact", "machineAdminContactType", "machineAdminName", "machineAdminPosition", "purpose", "requestedAt", "requesterName", "responsibleContact", "responsibleContactType", "responsibleName", "status", "userId" FROM "domain_requests";
